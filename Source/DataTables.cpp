...
std::vector<AircraftData> initializeAircraftData()
{
	...
	data[Aircraft::Eagle].hitpoints = 25; 
	...
	data[Aircraft::C83].hitpoints = 9001;
	data[Aircraft::C83].speed = 125.f;
	data[Aircraft::C83].texture = Textures::Entities;
	data[Aircraft::C83].textureRect = sf::IntRect(290, 0, 59, 60);
	data[Aircraft::C83].directions.push_back(Direction(0.f, 50.f));
	data[Aircraft::C83].fireInterval = sf::seconds(3);
	data[Aircraft::C83].hasRollAnimation = false;
...
std::vector<PickupData> initializePickupData()
{
	...
	data[Pickup::Speed].texture = Textures::Entities;
	data[Pickup::Speed].textureRect = sf::IntRect(190,64,40,40);
	data[Pickup::Speed].action = std::bind(&Aircraft::increaseSpeed, _1);
